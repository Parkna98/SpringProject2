...
function onMessage(event){
	...
	if(data.substring(0,3)==="msg") // oto, makeroom
	// msg:[이름] 메세지
	{
  ...
  <div class="container">
    ...
    <div class="row">
      <table class="table">
		<tr> 
		  <td>
		   	이름:<input type="text" id="name" size=15 class="input-sm" readonly value="${vo.userName}">
		   	<input type="button" value="입장" class="btn-info btn-sm" id="inputBtn">
		   	<input type="button" value="퇴장" class="btn-danger btn-sm" id="outputBtn">
		  </td>     
      	</tr>
      	<tr>
      	  <td>
